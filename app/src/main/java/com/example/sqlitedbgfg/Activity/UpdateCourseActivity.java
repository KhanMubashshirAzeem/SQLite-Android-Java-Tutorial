...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // one below lines we are getting data which
    ...
    public void updateCourseMethod(View view) {
        ...
        // launching our main activity.
        Intent i = new Intent(UpdateCourseActivity.this, ViewCoursesActivity.class);
        startActivity(i);
        finish();
    }

    public void deleteCourseMethod(View view) {
        dbHandler.deleteCourse(courseName);
        Toast.makeText(this, "Deleted the course", Toast.LENGTH_SHORT).show();
        Intent i = new Intent(UpdateCourseActivity.this, ViewCoursesActivity.class);
        startActivity(i);
    }
